...
#ifndef SRC_PLATFORM_LINUX_POSIX_EMULATION_LB_SHELL_LB_MUTEX_H_
#define SRC_PLATFORM_LINUX_POSIX_EMULATION_LB_SHELL_LB_MUTEX_H_
...
#endif  // SRC_PLATFORM_LINUX_POSIX_EMULATION_LB_SHELL_LB_MUTEX_H_
