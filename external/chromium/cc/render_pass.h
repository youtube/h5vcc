...
class RenderPassIdReuseList :
 ...
 public:
  static RenderPassIdReuseList* get_instance();
};

typedef ScopedPtrHashMap<RenderPass::Id, RenderPass, base::ShellAllocator<std::pair<const RenderPass::Id, RenderPass*>,  RenderPassIdReuseList> > RenderPassIdHashMap;
#else
