...
public:
    ...
    virtual void RunOnCCThread(const base::Closure& func) OVERRIDE;
#endif
...
#if defined(__LB_SHELL__)
    virtual void ensureContextCurrent() OVERRIDE;
#endif
...
#if defined(__LB_SHELL__)
    void RunOnCCThreadOnImplThread(const base::Closure& func);
#endif
