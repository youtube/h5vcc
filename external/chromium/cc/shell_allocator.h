...
#error This file should not be included in non steel builds!
    ...
    public std::hash_map<K, V, std::hash<K>, std::equal_to<K>, Allocator> { };
#elif defined(__LB_LINUX__)
    public base::hash_map<K, V, base::hash<K>, std::equal_to<K>, Allocator> { };
#else // All other LB_SHELL platforms
...
#error This file should not be included in non steel builds!
#elif defined(__LB_ANDROID__)
    public std::hash_set<V, std::hash<V>, std::equal_to<V>, Allocator> { };
#elif defined(__LB_LINUX__)
...
#endif  // __LB_USE_SHELL_REUSABLE_ALLOCATOR__
