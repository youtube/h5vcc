...
class MediaDrmBridge {
    ...
    private MediaDrmBridge(
            UUID schemeUUID, String securityLevel, int nativeMediaDrmBridge,
            boolean singleSessionMode, boolean privacyMode)
    ...
    private static MediaDrmBridge create(
            byte[] schemeUUID, String securityLevel, boolean privacyMode,
            int nativeMediaDrmBridge) {
        UUID cryptoScheme = getUUIDFromBytes(schemeUUID);
        ...
        // This override is a temporary work-around.
        // TODO: Re-evaluate multi-session mode.
        singleSessionMode = true;
    ...
    private void release() {
        // Do not reset mNativeMediaDrmBridge so that we can still
