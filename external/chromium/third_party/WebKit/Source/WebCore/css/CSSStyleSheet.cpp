...
#include "Document.h"
#if COMPILER(GHS)
// Element.h contains the inline implementation of hasTagName() referenced
// by this source file.  Other compilers are more forgiving about linking
// inline functions than GHS is.
#include "Element.h"
#endif
