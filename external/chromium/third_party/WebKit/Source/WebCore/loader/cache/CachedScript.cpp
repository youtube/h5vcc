...
const String& CachedScript::script()
{
    ...
    // lb shell is a client for a specific webapp. Automatically destroying
    // decoded script causes re-decoding very often which needs relatively
    // big memory blocks (600k+ for non-debug) to work.
