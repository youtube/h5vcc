...
class NinjaWriter:
  ...
  def WriteTarget(self, spec, config_name, config, link_deps, compile_deps):
    if spec['type'] == 'none':
      ...
      if (self.flavor not in ('mac', 'win', 'wiiu') and not
  ...
  def WriteNewNinjaRule(self, name, args, description, is_cygwin, env):
    ...
    if self.flavor == 'win':
      ...
      command = 'cd %s; ' % self.build_to_base + command
      if is_cygwin:
...
def CalculateVariables(default_variables, params):
  ...
  elif platform.system() != 'Linux' and (flavor == 'ps3' or flavor == 'wiiu'):
...
def GenerateOutputForConfig(target_list, target_dicts, data, params,
  ...
  if flavor == 'win':
    ...
    master_ninja.variable('ld', os.environ.get('LD', flock + ' linker.lock $cxx'))
    ...
    master_ninja.variable('default_stack_size', os.environ['DEFAULT_STACK_SIZE'])
  elif flavor == 'ps3':
    # Require LD to be set.
    master_ninja.variable('ld', flock + ' linker.lock ' + os.environ.get('LD'))
    master_ninja.variable('ar', os.environ.get('AR', 'ar'))
  ...
  if sys.platform == 'cygwin':
    import cygpath
    python_path = cygpath.to_nt('/usr/bin/python')
  else:
    python_path = 'python'
  master_ninja.variable('python', python_path)

  is_linux = platform.system() == 'Linux'
  fixup_dep_path = os.path.join(os.path.realpath(os.path.dirname(__file__) + '/../../../tools'), 'fixup_dep.py')
  if not is_linux:
    fixup_dep_path = cygpath.to_nt(fixup_dep_path)

  master_ninja.variable('fixup_dep', fixup_dep_path)
  ...
  if flavor != 'win':
    if flavor == 'wiiu' :
      master_ninja.rule(
        'cc',
        description='CC $out',
        command=('cmd.exe /c $cc @$out.rsp && $python gyp-wiiu-tool dep-normalize $out $out.d'),
        rspfile='$out.rsp',
      ...
      master_ninja.rule(
        'cxx',
        description='CXX $out',
        command=('cmd.exe /c $cxx @$out.rsp && $python gyp-wiiu-tool dep-normalize $out $out.d'),
        rspfile='$out.rsp',
        rspfile_content='-MMD $defines $includes $cflags $cflags_cc -c $in -o $out',
        depfile='$out.d')
    elif flavor == 'ps3' :
      cc_command=('$cc @$out.rsp && '
                  '$python $fixup_dep $out.d.raw $out.d $out')
      cxx_command=('$cxx @$out.rsp && '
                   '$python $fixup_dep $out.d.raw $out.d $out')
      if not is_linux:
      ...
      master_ninja.rule(
        ...
        command=cc_command,
        rspfile='$out.rsp',
        rspfile_content=('-MMD -MF $out.d.raw $defines $includes $cflags $cflags_c '
      ...
      master_ninja.rule(
        ...
        command=cxx_command,
        rspfile='$out.rsp',
        rspfile_content=('-MMD -MF $out.d.raw $defines $includes $cflags $cflags_cc '
      ...
      master_ninja.rule(
        ...
        command=('$cc -MMD -MF $out.d $defines $includes $cflags $cflags_c '
                '$cflags_pch_c -c $in -o $out && $fixup_dep $out.d.raw $out.d $out'),
        depfile='$out.d')
      master_ninja.rule(
        'cc_s',
        description='CC $out',
      ...
      master_ninja.rule(
        'cxx',
        description='CXX $out',
        command=('$cxx -MMD -MF $out.d.raw $defines $includes $cflags $cflags_cc '
                '$cflags_pch_cc -c $in -o $out && $fixup_dep $out.d.raw $out.d $out'),
        depfile='$out.d')
  ...
  if flavor != 'mac' and flavor != 'win' and flavor != 'wiiu' :
    ...
    if flavor == 'ps3' and not is_linux:
    ...
    if flavor == 'ps3':
      # PS3 linker doesn't know about rpath.
      rpath = ''
    else:
    ...
    master_ninja.rule(
      ...
      command=('$makerpl $in -f -nolib -t BUILD_TYPE=NDEBUG '
  ...
  if flavor == 'ps3' or flavor == 'wiiu' or flavor == 'linux':
    ...
    master_ninja.rule(
      ...
      command=cc_command,
      rspfile='$out.rsp',
      rspfile_content=('-MMD -MF $out.d.raw $defines $includes $cflags_host '
